...
void Model::Draw(Shader shader, GLuint handler)
{
	GLuint flag_rotLocation = glGetUniformLocation(shader.Program, "flag_rot"); //matriz de rotacion

	flag_rot = true;
	glUniform1i(flag_rotLocation,flag_rot);
...
void Model::Draw_normal(Shader shader, GLuint handler)
{
	GLuint flag_rotLocation = glGetUniformLocation(shader.Program, "flag_rot"); //matriz de rotacion
	flag_rot = false;
	glUniform1i(flag_rotLocation, flag_rot);
